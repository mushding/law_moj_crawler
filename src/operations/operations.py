...
from operations.utils.article_type import assign_article_type
...
def operations():
    ...
    if os.path.exists(law_operation_history_folder):
        shutil.rmtree(law_operation_history_folder)
    ...
    assign_article_type(law_operation_history_folder)
